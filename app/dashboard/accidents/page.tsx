...
export default function Accidents() {
  ...
  const editForm = (row: number) => {
    setDataToEdit(
      activeVehicleData.accident_data.find((data) => data.row === row)
    );
    openForm();
  };
      ...
      try {
        ...
        if (!error) {
          if (data != null) {
            ...
            if (updatedVehicleData.accident_data) {
              const indexToUpdate = updatedVehicleData.accident_data.findIndex(
                (accident) => accident.row === data.row
              );
      ...
      try {
        ...
        if (!error) {
          if (data != null) {
            ...
            if (updatedVehicleData.accident_data) {
              const indexToDelete = updatedVehicleData.accident_data.findIndex(
                (accident) => accident.row === data.row
              );
